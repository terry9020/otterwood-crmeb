    ...
    return {
      defaultConfig: {
        ...
        logoConfig: {
          ...
          title: '标题图片',
          tips: '建议：154px*32px',
          url: localStorage.getItem('mediaDomain') + '/otterwoodimage/perset/202412/bargainTitle.png',
        },
        selectBgImg: {
          cname: 'selectBgImg',
          title: '选择风格',
        ...
        bgImg: {
          ...
          title: '背景图片',
          tips: '建议：710px*96px',
          url: localStorage.getItem('mediaDomain') + '/otterwoodimage/perset/202412/bargainBg.png',
        },
        titleConfig: {
          title: '标题文字',
          val: '疯狂砍价',
