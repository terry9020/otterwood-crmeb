package com.otterwood.admin.task.brokerage;


import com.otterwood.admin.task.order.OrderReceiptTask;
...
public class BrokerageFrozenTask {
    ...
    public void brokerageFrozen() {
        // cron : 0 0 */1 * * ?
        logger.info("---BrokerageFrozenTask task------produce Data with fixed rate task: Execution Time - {}", OtterwoodDateUtil.nowDateTime());
        try {
